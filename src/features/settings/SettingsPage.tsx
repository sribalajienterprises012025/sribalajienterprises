...
type Tab = 'business' | 'staff' | 'activity'
...
export function SettingsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Settings"
        subtitle="Business details, staff access and activity"
      />

      <div className="px-4 lg:max-w-2xl lg:px-6">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <Field label="GSTIN" htmlFor="gstin">
                  <input
                    ...
                    value={form.gstin}
                    onChange={(event) =>
                      setForm({ ...form, gstin: event.target.value })
                    }
                    className={controlClass()}
                  />
                </Field>
              ...
              >
                <select
                  ...
                  onChange={(event) =>
                    setForm({
                      ...form,
                      fy_start_month: Number(event.target.value),
                    })
                  }
                  className={controlClass()}
                >
